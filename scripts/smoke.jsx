...
const cases = [
  ...
  ['NowPage', <NowPage tasks={tasks} onComplete={noop} />, ['One clear next step', 'Start here', 'Today item']],
  ...
  ['CalendarPage', <CalendarPage tasks={tasks} addTask={noop} setDeadline={noop} />, ['Calendar', 'calendar-grid', 'calendar-day']],
  ['SettingsPage', <SettingsPage tasks={tasks} appearance={appearance} importTasks={noop} clearCompleted={noop} askBeforeDelete onAskBeforeDeleteChange={noop} profile={{ name: 'TidyLine', setName: noop }} />, ['Accent colour', 'accent-swatch', 'Density', 'Reminder sound']],
]
...
console.log('\nAll Phase 2 surfaces mounted without throwing.')
